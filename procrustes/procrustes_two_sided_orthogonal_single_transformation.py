...
class TwoSidedOrthogonalSingleTransformationProcrustes(Procrustes):
    ...
    def calculate(self, return_u_approx=False, return_u_best=True, tol=1.e-12):
        ...
        array_ transformed = the transformed input array after transformation by u_umeyama_approx
        ...
        if return_u_approx:
            ...
            u_a, sigma_a, vt_a = self.singular_value_decomposition(array_a)
            u_a0, sigma_a0, vt_a0 = self.singular_value_decomposition(array_b)
            # Compute u_umeyama
        ...
        if return_u_approx and return_u_best:
            ...
            print "array_transformation_exact, error_approx, error_best:"
            return u_approx, u_best, array_transformed_approx, array_transformed_best, error_approx, error_best
