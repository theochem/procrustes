...
def softassign(array_a: np.ndarray, array_b: np.ndarray, iteration_soft: int = 50, iteration_sink: int = 200,
               beta_r: float = 1.10, beta_f: float = 1.e5, epsilon: float = 0.05, epsilon_soft: float = 1.e-3,
               epsilon_sink: float = 1.e-3, k: float = 0.15, gamma_scaler: float = 1.01, n_stop: int = 3,
               pad_mode: str = 'row-col', remove_zero_col: bool = True, remove_zero_row: bool = True,
               translate: bool = False, scale: bool = False, check_finite: bool = True, adapted: bool = True,
               beta_0: Optional[float] = None, m_guess: Optional[np.ndarray] = None,
               iteration_anneal: Optional[int] = None, kopt: bool = False, kopt_k: int = 3,
               weight: Optional[np.ndarray] = None) -> ProcrustesResult:
    r"""
